...
Пример карточки Lovelace и настройка Energy Dashboard (device_class: energy, state_class: total_increasing для счётчика энергии) — в [репозитории](https://github.com/Gfermoto/Vaillant) в описании конфигов и примерах.
