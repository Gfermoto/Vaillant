...
Представляет последнюю рабочую версию — все параметры, возвращавшие `ERR: invalid position`, закомментированы с объяснением причины.
- Удалены/закомментированы все параметры, относящиеся к газовым котлам и неприменимые к электрическим.
...
Оставшиеся нерешённые ошибки: [ebusd_eloBLOCK.log](https://github.com/Gfermoto/Vaillant/blob/main/ebusd_eloBLOCK.log)  
**(Буду признателен за помощь — особенно по параметрам d.103–d.108 электрических ступеней)**
...
- При размыкании сухого контакта (или через D.152=4) мощность будет 4 кВт (10 − 6 = 4).  
